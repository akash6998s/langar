...
const DonationsTable = () => {
  ...
  return (
    <div className="">
      ...
      <div className="max-w-6xl mx-auto rounded-2xl shadow-lg border border-[#f0d8b0] overflow-hidden bg-white">
        {/* Total Donations */}
        {tableData.length > 0 && (
  <div className="text-center bg-gradient-to-r from-[#fff4da] to-[#ffe6b3] py-5 px-4 text-[#4b1c0d] text-xl font-bold border-b-2 border-[#e0b973] shadow-md ">
    इस महीने की कुल राशि: <span className="text-[#a05a2c]">₹ {totalDonations}</span>
  </div>
)}
        ...
        {tableData.length > 0 ? (
          <div className="overflow-x-auto max-h-[500px]">
            <table className="w-full text-sm border border-[#f2dbb5] text-[#4b1c0d]">
              <thead className="bg-[#fff1d0] sticky top-0 z-10 text-[16px]">
                <tr>
                ...
                {tableData
                  ...
                  .map((row) => (
                    ...
                    >
                      ...
                      <td className="py-2 px-4 border border-[#f2dbb5] text-green-700 font-semibold">
                        ₹ {row.amount}
                      </td>
